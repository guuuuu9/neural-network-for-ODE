...
class LinearODEF(ODEF):
    def __init__(self):
        ...
        self.layer1 = nn.Linear(2, 4, bias=False)
        self.layer2 = nn.Tanh()
        self.layer3 = nn.Linear(4, 6, bias=False)
        self.layer4 = nn.Tanh()
        self.layer5 = nn.Linear(6, 4, bias=False)
        self.layer6 = nn.Tanh()
        self.layer7 = nn.Linear(4, 2, bias=False)
...
if __name__ == '__main__':
    ...
    def create_batch(X, t):
        ...
        t_copy = t.numpy()
        idx = sorted(index_np[(t_copy > t0) & (t_copy < t1)][:20])
        X = X.unsqueeze(1)
        t = t.unsqueeze(1)
        batch_targets = X[idx]
        batch_t = t[idx]
